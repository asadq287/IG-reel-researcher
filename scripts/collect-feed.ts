/**
 * Feed Mode: Scrolls the Instagram Reels feed with human-like timing.
 * Captures URLs, detects ads, extracts creator usernames.
 *
 * Usage: npx tsx instagram/content-research/collect-feed.ts [count]
 * Default: 20 reels
 *
...
async function collectFeed() {
  ...
  console.log(`[Feed Mode] Collecting ~${count} reels...\n`);
